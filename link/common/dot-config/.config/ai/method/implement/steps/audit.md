...
**So plan one round, and earn every further one.** Nothing in a round's output tells you whether another would find more, and the rounds do not converge on their own — which cuts both ways, and the count is the largest lever you have over what a run costs.

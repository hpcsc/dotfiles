...
for i in software-properties-common apt-transport-https lsb-release curl build-essential zlib1g-dev libssl-dev libffi-dev libreadline-dev libclang-dev; do
